...
public class program8 {
	...
	public static void main(String[] args) throws IOException{
		...
		catch(EOFException error)//the errors that may be caught and then it outputs explaining why and shows the error message
		{
		...
		{
			System.out.println("Sorry, I cannot locate that file.");
			System.out.println("Error Message: " + error.getMessage());
		}
